...
class RolloutStorage(object):
    ...
    def constraint_feed_forward_generator(self,
                               advantages,
                               cost_advantages,
                               num_mini_batch=None,
                               mini_batch_size=None):
        ...
        for indices in sampler:
            ...
            if advantages is None:
                ...
                adv_targ = advantages.view(-1, 1)[indices]
                cost_adv_targ = cost_advantages.view(-1, 1)[indices]
            yield obs_batch, recurrent_hidden_states_batch, actions_batch, \
                value_preds_batch, return_batch, masks_batch, old_action_log_probs_batch, adv_targ, cost_adv_targ
