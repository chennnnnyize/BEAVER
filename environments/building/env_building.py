...
class BuildingEnv_2d(gym.Env):
    ...
    def default_reward_function(self, state, action, error, state_new, step_idx):
        ...
        return reward_comfort, reward_price
    ...
    def step(self, action):
        ...
        reward_comfort, reward_price= self.reward_function(self.state, action, error, X_new, step_idx)
        ...
        return state, np.array([reward_comfort, reward_price],dtype=np.float32), done, done, {}
