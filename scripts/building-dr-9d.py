...
parser.add_argument('--save-dir', type=str, default='./results/Building-dr-9d')
...
for i in range(args.num_seeds):
    ...
    if test_cmorl_ipo:
        cmd = f'python morl/run.py '\
            f'--env-name building_dr_9d --obj-num 9 '\
            f'--seed {seed} '\
            f'--num-time-steps 3000000 '\
            f'--num-init-steps 2000000 '\
